...
(function(global){
  ...
  HTMLParser = global.HTMLParser || require('./htmlparser').HTMLParser;
  uglify = global.uglify || require('uglify-js');
    ...
    HTMLParser(value, {
      ...
      chars: function( text, prevTag, nextTag ) {
        if (currentTag === 'script' || currentTag === 'style') {
          ...
          if (currentTag === 'script' && options.compressJs) {
